...
docRef.setAttribute("style", "position: fixed;right: 0;top: 0;height: 100vh;width: 400px;background: white;box-shadow: -9px -5px 11px -6px rgba(0,0,0,0.75);z-index:1001")
docRef.setAttribute("id", "quizzes");
document.getElementsByTagName("body")[0].appendChild(docRef)
document.getElementsByTagName("body")[0].setAttribute("style", "width: calc(100% - 400px);");
